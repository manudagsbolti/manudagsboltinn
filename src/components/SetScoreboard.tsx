...
export function SetScoreboard({ set, teams, games, winsPerPoint, pointsToWinSet, setWins = {}, playerNames = {} }: { set: SetRecord; teams: SetTeam[]; games: Game[]; winsPerPoint: number; pointsToWinSet: number; setWins?: Record<string, number>; playerNames?: Record<string,string> }) {
